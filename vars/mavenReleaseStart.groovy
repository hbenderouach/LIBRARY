def call(def releaseVersionParam, def developmentVersionParam) {
      ...
      sh "mvn clean jgitflow:release-start -Dusername=${AEM_USERNAME} -Dpassword=${AEM_PASSWORD} -DreleaseVersion=${releaseVersionParam} -DdevelopmentVersion=${developmentVersionParam}"
	}
}